...
// Timezone with geolocation - only valid IANA timezone IDs
const TIMEZONE_DATA: { [key: string]: { offset: number; lat: number; lng: number; city: string } } = {
  // North America (valid IANA IDs only)
  ...
  'America/Edmonton': { offset: -420, lat: 53.5461, lng: -113.4938, city: 'Edmonton' },
  'America/Winnipeg': { offset: -360, lat: 49.8951, lng: -97.1384, city: 'Winnipeg' },
  // Latin America
  ...
  'America/Argentina/Buenos_Aires': { offset: -180, lat: -34.6037, lng: -58.3816, city: 'Buenos Aires' },
  ...
  'Europe/Kyiv': { offset: 120, lat: 50.4501, lng: 30.5234, city: 'Kyiv' },
  ...
  'Asia/Qatar': { offset: 180, lat: 25.2854, lng: 51.5310, city: 'Doha' },
